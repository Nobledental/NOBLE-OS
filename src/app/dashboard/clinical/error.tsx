...
export default function Error({
    ...
    useEffect(() => {
        console.error('Clinical page error:', error);
    }, [error]);
            ...
            <div className="max-w-md w-full space-y-6 text-center">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-slate-500 text-sm">
                        Unable to load clinical data. This might be due to network issues or a temporary service disruption.
                    </p>
                    {error.message && (
                ...
                <p className="text-xs text-slate-400">
                    Patient data is safe. Contact IT support if this persists.
                </p>
            </div>
        </div>
    );

            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div>
                        ...
                        <p className="text-slate-500 font-medium">Manage clinical SEEAT (Search, Experience, Expertise, Authoritativeness, Trustworthiness).</p>
                    </div>

                    <div className="bg-white p-1.5 rounded-2xl border border-slate-200 flex gap-1 shadow-2xl shadow-indigo-500/10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div className="bg-white rounded-[2.5rem] p-8 border border-slate-200 shadow-xl hover:shadow-2xl transition-all duration-500 flex flex-col justify-between group">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {/* Insights Hub */}
                    <div className="lg:col-span-1 bg-white rounded-[2.5rem] border border-slate-200 shadow-xl p-8 space-y-8">
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                <div key={i} className="flex gap-4 p-4 rounded-3xl bg-slate-50 border border-slate-100">
                                    ...
                                    <p className="text-xs font-medium text-slate-600 leading-relaxed">{item.msg}</p>
                                </div>
                            ))}
                        </div>
                    </div>

            ...
            <div className="max-w-[1600px] mx-auto space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    >
                        <div className="relative z-10">
                            ...
                            <h1 className="text-3xl font-black tracking-tighter">C3 Control Room</h1>
                            <p className="text-xs font-medium text-slate-400 mt-1">Fusing Logistics, Clinical, and Brand Intelligence.</p>
                        </div>
                        <div className="relative z-10 text-right">
                            <div className="text-4xl font-black tracking-tighter text-blue-600 dark:text-blue-400">98.2%</div>
                    ...
                    {[
                        ...
                        <div key={i} className="bg-white dark:bg-[#0a0f1d] p-6 rounded-[2rem] border border-slate-200 dark:border-white/5 shadow-xl flex items-center gap-4">
                            ...
                            <div>
                                <div className="text-sm font-black">{app.label}</div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        <div className="bg-white dark:bg-[#0a0f1d] p-8 rounded-[3rem] border border-slate-200 dark:border-white/5 shadow-2xl relative">
                            <div className="flex items-center justify-between mb-8">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h2 className="text-lg font-black uppercase tracking-tighter">Lead Command</h2>
                                </div>
                                ...
                                {leads.map((lead) => (
                                    ...
                                    >
                                        <div className="flex justify-between items-start">
                                            <div>
                                                <div className="font-black text-sm group-hover:text-blue-500 transition-colors">{lead.name}</div>
                        ...
                        <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white shadow-2xl overflow-hidden relative group">
                            <h3 className="text-xl font-black uppercase tracking-tighter mb-4 relative z-10">C3 Predictive</h3>
                            <div className="space-y-4 relative z-10">
                                ...
                                <div className="flex items-center gap-4 pt-4">
                                    <div className="text-2xl font-black text-amber-500">Restock Hub</div>
                    ...
                    <div className="lg:col-span-5 space-y-8">
                        <div className="bg-white dark:bg-[#0a0f1d] p-10 rounded-[3rem] border border-slate-200 dark:border-white/5 shadow-2xl h-full flex flex-col">
                            <div className="flex items-center justify-between mb-10">
                                <div>
                                    <h2 className="text-2xl font-black uppercase tracking-tighter">Surgical Lifecycle</h2>
                            ...
                            <div className="grid grid-cols-2 gap-6 flex-1">
                                {[
                                    ...
                                    <div key={i} className="p-6 bg-slate-50 dark:bg-white/5 rounded-3xl border border-slate-100 dark:border-white/5 hover:scale-105 transition-all">
                                        ...
                                        <div className="text-2xl font-black tracking-tighter">{clinical.value}</div>
                    ...
                    <div className="lg:col-span-3 space-y-6">
                        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 p-8 rounded-[3rem] text-white shadow-2xl relative overflow-hidden group">
                            <div className="relative z-10 flex items-center justify-between mb-8">
                                <h3 className="text-xl font-black uppercase tracking-tighter">Ranking Intelligence</h3>
                                <Trophy className="text-amber-400" />
                            </div>

                            <div className="space-y-8 relative z-10">
                                <div>
                                    <div className="text-5xl font-black tracking-tighter">92 <span className="text-xl">ATR</span></div>
                        ...
                        <div className="bg-white dark:bg-[#0a0f1d] p-8 rounded-[2.5rem] border border-slate-200 dark:border-white/5 shadow-xl">
                            <h4 className="font-black text-lg uppercase tracking-tighter mb-6 dark:text-white">Insta-Stock Hub</h4>
                                ...
                                {[
                                    ...
                                    <div key={i} className="flex items-center justify-between">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="text-sm font-black dark:text-white">{item.item}</div>
                ...
                <div className="p-8 bg-slate-50 dark:bg-white/5 rounded-[3rem] border border-slate-100 dark:border-white/5 flex flex-col md:flex-row md:items-center justify-between gap-8">
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            <h3 className="text-xl font-black uppercase tracking-tighter dark:text-white">Unified Telemetry</h3>

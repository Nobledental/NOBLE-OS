    ...
    return (
        <div className="space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <PanzeCard className="bg-slate-50 p-6 flex items-center justify-between border-slate-200">
                    <div>
                ...
                <PanzeCard className="bg-slate-50 p-6 flex items-center justify-between border-slate-200">
                    <div>
                        ...
                        <h3 className="text-3xl font-bold text-red-600">08</h3>
                    </div>
                ...
                <PanzeCard className="bg-slate-50 p-6 flex items-center justify-between border-slate-200">
                    <div>
                        ...
                        <h3 className="text-3xl font-bold text-amber-600">03</h3>
                    </div>
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between px-2">
                    <h2 className="text-xl font-bold text-slate-900 flex items-center gap-3 italic tracking-tighter uppercase">
                        Stock Registry
                    </h2>
                ...
                <div className="space-y-3">
                    {MOCK_INVENTORY.map((item, i) => (
                        <div key={i} className="flex items-center justify-between bg-white p-6 rounded-3xl border border-slate-100 shadow-sm group hover:border-blue-500/20 transition-all">

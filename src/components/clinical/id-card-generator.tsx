            ...
            >
                ...
                <div className="flex items-center gap-3 relative z-10">
                    ...
                    <div>
                        ...
                        <p className="text-[8px] font-bold text-indigo-500 uppercase tracking-widest leading-none mt-1">Premium Care</p>
                    </div>
                </div>
                ...
                <div className="mt-10 flex flex-col items-center gap-6 relative z-10">
                    ...
                    <div className="text-center space-y-1">
                        ...
                        <p className="text-[10px] font-bold text-indigo-600 uppercase tracking-[0.2em]">{staff.role}</p>
                    </div>
                </div>

                {/* Details Grid */}
                <div className="mt-12 grid grid-cols-2 gap-x-8 gap-y-6 relative z-10 p-6 bg-slate-50/80 rounded-[2rem] border border-slate-100 backdrop-blur-md">

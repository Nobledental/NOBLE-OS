...
import "react-day-picker/dist/style.css"; // Ensure styles are imported if not using shadcn preset
        ...
        <DayPicker
            ...
            classNames={{
                ...
                nav_button: cn(
                    ...
                    "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 text-slate-900"
                ),
                ...
                day: cn(
                    ...
                    "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-slate-900 hover:bg-slate-100 hover:text-slate-900"
                ),

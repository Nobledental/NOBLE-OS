        ...
        <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#020617] p-8">
            <div className="max-w-5xl mx-auto space-y-10">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-10">
                        <div className="space-y-6 max-w-xl">
                            ...
                            <div className="flex gap-4">
                                <button className="px-8 py-4 bg-white text-indigo-600 rounded-2xl font-black text-xs uppercase tracking-widest hover:scale-105 transition-all shadow-xl">
                                    Manage Subscription
                                </button>
                                <button className="px-8 py-4 bg-white/10 text-white rounded-2xl font-black text-xs uppercase tracking-widest border border-white/20 hover:bg-white/20 transition-all">
                                    Gift Membership
                                </button>
                            </div>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        { title: 'Priority Access', desc: 'Skip the wait with exclusive member slots.', icon: Clock, color: 'text-blue-500', bg: 'bg-blue-50 dark:bg-blue-900/10' },
                        { title: 'Unlimited Tele-Care', desc: 'Zero-cost follow-ups with your clinical team.', icon: PhoneCall, color: 'text-purple-500', bg: 'bg-purple-50 dark:bg-purple-900/10' },
                        { title: 'Specialist Concierge', desc: 'Direct access to senior clinicians 24/7.', icon: UserCircle, color: 'text-pink-500', bg: 'bg-pink-50 dark:bg-pink-900/10' },
                    ].map((benefit, i) => (
                        <div key={i} className="bg-white dark:bg-[#0a0f1d] p-8 rounded-[2.5rem] border border-slate-200 dark:border-white/5 shadow-xl hover:scale-[1.02] transition-all">
                ...
                <div className="bg-white dark:bg-[#0a0f1d] rounded-[3rem] border border-slate-200 dark:border-white/5 shadow-2xl overflow-hidden">
                    ...
                    <div className="p-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="p-6 bg-slate-50 dark:bg-white/5 rounded-[2rem] border border-slate-100 dark:border-white/5 group hover:border-pink-200 transition-all">
                                ...
                                <button className="mt-6 w-full py-3 bg-slate-900 dark:bg-white/10 text-white rounded-xl font-bold text-[10px] uppercase tracking-widest hover:bg-pink-600 transition-all">
                                    Setup Auto-ship
                                </button>
                            </div>
                        ))}

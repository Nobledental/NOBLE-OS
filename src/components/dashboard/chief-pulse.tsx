...
export function ChiefPulse() {
    return (
        <PanzeCard className="col-span-3 border-none shadow-sm bg-white/60 backdrop-blur-md">
            ...
            <div className="space-y-3">
                {MOCK_PULSE.map((item) => (
                    <div key={item.id} className="flex items-center justify-between p-3 rounded-2xl bg-white border border-slate-100 transition-all hover:scale-[1.02] hover:shadow-md cursor-default group">

    ...
    return (
        <div className="flex-1 space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-4xl lg:text-5xl font-serif italic tracking-tighter text-slate-900 dark:text-white">Appointments</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <PanzeCard className="md:col-span-2 glass-neo border-slate-100 dark:border-white/5 bg-white/[0.01] p-0 flex flex-col min-h-[500px] overflow-hidden">
                ...
                <div className="space-y-6">
                    <PanzeCard className="glass-neo border-slate-100 dark:border-white/5 bg-white/[0.01] p-8">
                        <div className="mb-8">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-2xl font-serif italic text-slate-900 dark:text-white">18</span>
                            </div>
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                ...
                                <span className="text-2xl font-serif italic text-slate-900 dark:text-white">5</span>
                            </div>
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                ...
                                <span className="text-2xl font-serif italic text-slate-900 dark:text-white">2</span>
                            </div>
                        </div>
                    </PanzeCard>

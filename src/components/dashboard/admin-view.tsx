...
export function AdminDashboardView({ activeFilter = "This Month" }: AdminDashboardViewProps) {
    return (
        <div className="space-y-12 min-h-[800px] pb-32 px-4 lg:px-0">
            {/* 1. Admin Quick Stats & Vitality (Apple Refined Style) */}
            <motion.div
                initial="hidden"
                animate="visible"
                variants={{
                ...
                <PanzeCard className="md:col-span-2 group glass-white border-white/40 bg-white/60 text-slate-900 relative overflow-hidden flex flex-col justify-between min-h-[280px] transition-all duration-700">
                    <div className="relative z-10 p-4">
                        ...
                        <div className="flex flex-col">
                            <span className="text-[11px] uppercase tracking-[0.4em] font-black text-neo-vibrant-blue/60 leading-none">CORE COMMAND SERVER</span>
                            <span className="text-[9px] font-bold text-slate-400 mt-1 uppercase tracking-widest">{activeFilter} ARCHIVE</span>
                        </div>
                    </div>

                ...
                {MANAGEMENT_FEATURES.map((feature, i) => {
                    const CardContent = (
                        ...
                        >
                            ...
                            <div className="bg-white dark:glass-frost rounded-xl overflow-hidden relative p-3 h-full flex flex-col min-h-[120px] mb-0 border-slate-200 dark:border-white/10 shadow-sm hover:shadow-md transition-all duration-1000 group-hover:bg-slate-50 dark:group-hover:bg-white/[0.04]">
                                ...
                                <div className="flex justify-between items-start relative z-10 mb-5">
                                    ...
                                    <div className="flex flex-col items-end gap-1.5 opacity-60">
                                        <span className="text-[9px] font-black uppercase tracking-[0.3em] text-slate-600 dark:text-slate-400">{feature.category}</span>
                                        {feature.locked ? (
                                ...
                                <div className="mt-auto relative z-10 flex flex-col gap-1">
                                    <div className="flex items-center gap-2 mb-1.5">
                                        ...
                                        <span className="text-[11px] font-black uppercase tracking-[0.1em] text-slate-500 dark:text-slate-400">{feature.chip}</span>
                                    </div>

...
const MANAGEMENT_FEATURES = [
    ...
    },
    {
        ...
        bg: "bg-amber-50",
        href: "/dashboard/admin/chairs" // Assuming a route or placeholder
    },
    {
    ...
    {
        title: "Insurance & TPA",
        subtitle: "Empanelment, packages, documents",
        icon: ShieldCheck,
        chip: "Insurance",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {MANAGEMENT_FEATURES.map((feature, i) => (
                <Link key={i} href={feature.locked ? "#" : feature.href} className={feature.locked ? "cursor-not-allowed opacity-60" : ""}>
                    <PanzeCard
                        className="p-6 cursor-pointer hover:shadow-md transition-shadow group flex flex-col items-start gap-4 border-none shadow-sm h-full relative"
                    >
                        {feature.locked && (

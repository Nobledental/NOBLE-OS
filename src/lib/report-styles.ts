export const NOBLE_BRAND = {
    colors: {
        ...
        cardBorder: '#E5E7EB',
        // Added for smart-report-generator compliance
        positive: '#10B981',  // Green for successful/positive indicators
        warning: '#F59E0B',   // Amber for warning indicators  
        danger: '#EF4444',    // Red for danger/critical indicators
    },
    clinic: {
        ...
        facility: 'Advanced Dental Care Facility',
        address: 'Bangalore, Karnataka, India',
        phone: '+91-XXXXXXXXXX',  // Replace with actual clinic phone
    },
    // Added for smart-report-generator compliance
    footer: {
        endOfReport: '— END OF REPORT —',
        disclaimer: 'This is a computer-generated document. No signature is required.',
        system: 'Generated by NOBLE-OS Clinical Management System',
    }
};
